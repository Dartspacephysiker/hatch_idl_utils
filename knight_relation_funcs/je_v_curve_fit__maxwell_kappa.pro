...
FUNCTION JE_V_CURVE_FIT__MAXWELL_KAPPA,X,P, $
                                       IN_POTBAR=in_potBar, $
                                       OUT_POTBAR=potBar, $
  ...
  CASE 1 OF
     KEYWORD_SET(is_Maxwellian_fit): BEGIN
        ...
        jePar = KAPPA_1__DORS_KLETZING_EQ_14__EFLUX__MAXWELL(T_m,dens_m,pot,R_B, $
                                                             IN_POTBAR=in_potBar, $
                                                             OUT_POTBAR=potBar, $
     ...
     END
     ELSE: BEGIN
        jePar = KAPPA_1__DORS_KLETZING_EQ_15__EFLUX(kappa,T_m,dens_m,pot,R_B, $
                                                    IN_POTBAR=in_potBar, $
                                                    OUT_POTBAR=potBar, $
