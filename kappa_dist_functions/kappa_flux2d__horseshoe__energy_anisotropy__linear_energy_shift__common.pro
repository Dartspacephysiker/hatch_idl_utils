...
FUNCTION KAPPA_FLUX2D__HORSESHOE__ENERGY_ANISOTROPY__LINEAR_ENERGY_SHIFT__COMMON,X,Y,P, $
  ...
  CASE 1 OF
     ...
     ELSE: BEGIN
        FOR i=0,nAngles-1 DO BEGIN
           ...
           angleSlice = KAPPA_FLUX__LINEAR_SHIFT_IN_ENERGY(tempEn,tempP,UNITS=units,MASS=mass)
