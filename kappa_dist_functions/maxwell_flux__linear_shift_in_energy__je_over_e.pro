...
;; modelFluxOverE=MAXWELL_FLUX__LINEAR_SHIFT_IN_ENERGY__JE_OVER_E(energies,P)
;; fluxOverE=flux[2:-1]/energies[2:-1]
;; plot1=PLOT((energies[2:-1]-energies[1])/1000.D,fluxOverE,XTITLE="Energy-$\Delta\Phi$ (keV)",YTITLE="J(E)/E (cm!U2!N-s-sr-eV!U2!N)",XLOG=1,YLOG=1,YRANGE=[MIN(fluxOverE)/2,MAX([fluxOverE,modelFluxOverE])],LINESTYLE='',SYMBOL='+')
